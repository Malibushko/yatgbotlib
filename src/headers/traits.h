...
constexpr uint32_t telegram_subnet_start = 2509938689;
constexpr uint32_t telegram_subnet_end = 2509942782;
constexpr uint32_t telegram_subnet_start2 = 1533805569;
constexpr uint32_t telegram_subnet_end2 = 1533806590;
